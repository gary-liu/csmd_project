/*
 ...
 Source Schema         : csmd-shop

 Target Server Type    : MySQL
 Target Server Version : 50715
 File Encoding         : 65001

 Date: 24/02/2020 08:28:44
*/
...
-- ----------------------------
-- Table structure for csmd_account_trace
-- ----------------------------
DROP TABLE IF EXISTS `csmd_account_trace`;
CREATE TABLE `csmd_account_trace`  (
...
-- ----------------------------
-- Table structure for csmd_ad
-- ----------------------------
DROP TABLE IF EXISTS `csmd_ad`;
CREATE TABLE `csmd_ad`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '广告表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_address
-- ----------------------------
DROP TABLE IF EXISTS `csmd_address`;
CREATE TABLE `csmd_address`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '收货地址表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_admin
-- ----------------------------
DROP TABLE IF EXISTS `csmd_admin`;
CREATE TABLE `csmd_admin`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_article
-- ----------------------------
DROP TABLE IF EXISTS `csmd_article`;
CREATE TABLE `csmd_article`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_brand
-- ----------------------------
DROP TABLE IF EXISTS `csmd_brand`;
CREATE TABLE `csmd_brand`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1001074 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌商表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_cart
-- ----------------------------
DROP TABLE IF EXISTS `csmd_cart`;
CREATE TABLE `csmd_cart`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 457 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '购物车商品表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_category
-- ----------------------------
DROP TABLE IF EXISTS `csmd_category`;
CREATE TABLE `csmd_category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE = InnoDB AUTO_INCREMENT = 100100205 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '类目表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_collect
-- ----------------------------
DROP TABLE IF EXISTS `csmd_collect`;
CREATE TABLE `csmd_collect`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户表的用户ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '收藏表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_comment
-- ----------------------------
DROP TABLE IF EXISTS `csmd_comment`;
CREATE TABLE `csmd_comment`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_coupon
-- ----------------------------
DROP TABLE IF EXISTS `csmd_coupon`;
CREATE TABLE `csmd_coupon`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券信息及规则表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_coupon_user
-- ----------------------------
DROP TABLE IF EXISTS `csmd_coupon_user`;
CREATE TABLE `csmd_coupon_user`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 124 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券用户使用表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_del_picture
-- ----------------------------
DROP TABLE IF EXISTS `csmd_del_picture`;
CREATE TABLE `csmd_del_picture`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_feedback
-- ----------------------------
DROP TABLE IF EXISTS `csmd_feedback`;
CREATE TABLE `csmd_feedback`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户表的用户ID',
...
-- ----------------------------
-- Table structure for csmd_footprint
-- ----------------------------
DROP TABLE IF EXISTS `csmd_footprint`;
CREATE TABLE `csmd_footprint`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户表的用户ID',
  ...
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户浏览足迹表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_goods
-- ----------------------------
DROP TABLE IF EXISTS `csmd_goods`;
CREATE TABLE `csmd_goods`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE = InnoDB AUTO_INCREMENT = 23853 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品基本信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_goods_attribute
-- ----------------------------
DROP TABLE IF EXISTS `csmd_goods_attribute`;
CREATE TABLE `csmd_goods_attribute`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE = InnoDB AUTO_INCREMENT = 619031 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品参数表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_goods_product
-- ----------------------------
DROP TABLE IF EXISTS `csmd_goods_product`;
CREATE TABLE `csmd_goods_product`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT 0 COMMENT '商品表的商品ID',
  ...
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 339135 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品货品表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_goods_specification
-- ----------------------------
DROP TABLE IF EXISTS `csmd_goods_specification`;
CREATE TABLE `csmd_goods_specification`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT 0 COMMENT '商品表的商品ID',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `goods_id`(`goods_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 181683 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品规格表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_groupon
-- ----------------------------
DROP TABLE IF EXISTS `csmd_groupon`;
CREATE TABLE `csmd_groupon`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL COMMENT '关联的订单ID',
  `groupon_id` int(11) NULL DEFAULT 0 COMMENT '参与的团购ID，仅当user_type不是1',
  `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联csmd_groupon_rules表ID字段',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
-- ----------------------------
-- Table structure for csmd_groupon_rules
-- ----------------------------
DROP TABLE IF EXISTS `csmd_groupon_rules`;
CREATE TABLE `csmd_groupon_rules`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_issue
-- ----------------------------
DROP TABLE IF EXISTS `csmd_issue`;
CREATE TABLE `csmd_issue`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_keyword
-- ----------------------------
DROP TABLE IF EXISTS `csmd_keyword`;
CREATE TABLE `csmd_keyword`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_order
-- ----------------------------
DROP TABLE IF EXISTS `csmd_order`;
CREATE TABLE `csmd_order`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户表的用户ID',
...
-- ----------------------------
-- Table structure for csmd_order_goods
-- ----------------------------
DROP TABLE IF EXISTS `csmd_order_goods`;
CREATE TABLE `csmd_order_goods`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `goods_id`(`goods_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单商品表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_permission
-- ----------------------------
DROP TABLE IF EXISTS `csmd_permission`;
CREATE TABLE `csmd_permission`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_region
-- ----------------------------
DROP TABLE IF EXISTS `csmd_region`;
CREATE TABLE `csmd_region`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_role
-- ----------------------------
DROP TABLE IF EXISTS `csmd_role`;
CREATE TABLE `csmd_role`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_search_history
-- ----------------------------
DROP TABLE IF EXISTS `csmd_search_history`;
CREATE TABLE `csmd_search_history`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户表的用户ID',
  ...
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '搜索历史表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_storage
-- ----------------------------
DROP TABLE IF EXISTS `csmd_storage`;
CREATE TABLE `csmd_storage`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_system
-- ----------------------------
DROP TABLE IF EXISTS `csmd_system`;
CREATE TABLE `csmd_system`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统配置表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_topic
-- ----------------------------
DROP TABLE IF EXISTS `csmd_topic`;
CREATE TABLE `csmd_topic`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE = InnoDB AUTO_INCREMENT = 265 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '专题表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_user
-- ----------------------------
DROP TABLE IF EXISTS `csmd_user`;
CREATE TABLE `csmd_user`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for csmd_user_account
-- ----------------------------
DROP TABLE IF EXISTS `csmd_user_account`;
CREATE TABLE `csmd_user_account`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户表的用户ID',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '账户表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for csmd_user_formid
-- ----------------------------
DROP TABLE IF EXISTS `csmd_user_formid`;
CREATE TABLE `csmd_user_formid`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
